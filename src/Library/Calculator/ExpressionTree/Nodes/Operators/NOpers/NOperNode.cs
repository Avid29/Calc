...
public abstract class NOperNode : OperNode
{
    ...
    public static NOperNode MakeNOperNode(char c) => c switch
    {
    ...
    /// <inheritdoc/>
    public override void ReplaceChild(ExpNode node, int index) => Children[index] = node;
    ...
    /// <inheritdoc/>
    public override ExpNode GetChild(int index) => Children[index];
