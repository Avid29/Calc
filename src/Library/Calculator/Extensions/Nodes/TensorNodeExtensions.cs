...
public static class TensorNodeExtensions
{
    ...
    public static bool AreEqualSize(this TensorNode node, TensorNode other) => node.SizeIdentity == other.SizeIdentity;
    ...
    public static bool AreEqualSizeVectors(this TensorNode node, TensorNode other) => node.DimensionCount == 1 && node.AreEqualSize(other);
