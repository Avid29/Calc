...
public static class QuickOpers
{
    ...
    public static AdditionOperNode Add(double value, ExpNode node) => Sum(MakeNumericalNode(value), node);
    ...
    public static MultiplicationOperNode Multiply(double value, ExpNode node) => Multiply(MakeNumericalNode(value), node);
    ...
    public static SignOperNode Negative(ExpNode node) => new(Sign.Negative) { Child = node };
    ...
    /// <param name="exponent">The exponent of the <see cref="PowOperNode"/>.</param>
    /// <returns>A new <see cref="PowOperNode"/> as <paramref name="base"/>^<paramref name="exponent"/>.</returns>
    public static PowOperNode Pow(ExpNode @base, double exponent) => Pow(@base, MakeNumericalNode(exponent));
    ...
    public static RecipricalOperNode Reciprical(ExpNode node) => new() { Child = node };
