...
public class MultiplicativeTerm : IEquatable<MultiplicativeTerm>, IComparable<MultiplicativeTerm>
{
    ...
    /// <summary>
    /// Converts the <see cref="MultiplicativeTerm"/> back to an <see cref="ExpNode"/>.
    /// </summary>
    /// <returns>The <see cref="MultiplicativeTerm"/> as an <see cref="ExpNode"/>.</returns>
    ...
    public void AddToExponent(MultiplicativeTerm other, Simplifier simplifier) => _exponent = QuickOpers.Sum(_exponent, other._exponent).Execute(simplifier);
